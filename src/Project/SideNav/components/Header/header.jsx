        ...
        <div className="w-11/12 m-auto flex items-center justify-between">
          <div className="flex">
            ...
            <h1 className="text-xl font-bold tracking-wide">
              {headerTextMap[loc.pathname] || "HEADER"}
            </h1>
          </div>
          <div>
            <FiMoreHorizontal className="text-3xl" />
          </div>
          <NavLink to={"/dashboard/Members"} className="flex space-x-1">
            <img
              width={40}
              className="rounded-full"
              src="https://avatars2.githubusercontent.com/u/6184"
              alt=""
            />
            <img
              width={40}
              className="rounded-full"
              src="https://avatars2.githubusercontent.com/u/6181"
              alt=""
            />
            <img
              width={40}
              className="rounded-full"
              src="https://avatars2.githubusercontent.com/u/6176"
              alt=""
            />
          </NavLink>
        </div>
          ...
          <ul className="w-11/12 mr-auto ml-auto space-x-4">
            <NavLink
              className={({ isActive, isPending }) =>
                isPending ? inActive : isActive ? Active : inActive
              }
              to={`project/${id}`}
              end
            >
              {" "}
              <span className="mb-2.5">Tasks</span>
            </NavLink>
            <NavLink
              className={({ isActive, isPending }) =>
                isPending ? inActive : isActive ? Active : inActive
            ...
            >
              {" "}
              <span className="mb-2.5">Activity</span>
            </NavLink>
            <NavLink
              className={({ isActive, isPending }) =>
                isPending ? inActive : isActive ? Active : inActive
              }
              to={`project/${id}/Calander`}
            >
              {" "}
              <span className="mb-2.5">Calander</span>
            </NavLink>
            <NavLink
              className={({ isActive, isPending }) =>
                isPending ? inActive : isActive ? Active : inActive
            ...
            >
              {" "}
              <span className="mb-2.5">Files</span>
            </NavLink>
          </ul>
        ) : null}
      </div>
